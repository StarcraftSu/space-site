...
var RevealOnScroll = function () {
	function RevealOnScroll(ele, offset) {
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.pageSections = (0, _jquery2.default)('.page-section'); //grab elements has page-section class
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							...
							(0, _jquery2.default)(matchingHeaderLink).addClass('is-current-link'); //Convert Js element to jQuery 
						}
					},
					offset: "18%"
				});
